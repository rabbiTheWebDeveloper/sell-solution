        ...
        <div className="sidebar_content">
          ...
          <div className="menuItem">
            ...
            <li className={props.active == 'dashboard' && 'active'}>
                <Link to="/dashboard" className=" d_flex">
                  <div className="svg">
                    <svg
                      width={22}
                      height={22}
              ...
              <li className="dropdown">
                ...
                >
                  <li className={props.active == 'product' && 'active'}>
                    <Link className="dropdown-item" to="/product">
                      Product
                    </Link>
                  </li>
                  <li className={props.active == 'product_category' && 'active'}>
                    <Link className="dropdown-item" to="/add_category">
                      Product Category
                    </Link>
                  </li>
                </ul>
              </li>
              <li className={props.active == 'courier' && 'active'}>
                <Link to="courier" className="d_flex">
                  <div className="svg">
                    <svg
                      width={23}
                      height={19}
              ...
              <li className="dropdown">
                ...
                <ul
                  ...
                  aria-labelledby="dropdownMenuLink"
                >
                  <li className={props.active == 'inventory' && 'active'}>
                    <Link className="dropdown-item" to="/inventory">
                      Inventory
                    </Link>
                  </li>
                  <li className={props.active == 'stock_in' && 'active'}>
                    <Link className="dropdown-item" to="/stock_in">
                      Stock In
                    </Link>
                  </li>
                  <li className={props.active == 'product_return' && 'active'}>
                    <Link className="dropdown-item" to="/product_return">
                      Product Return
                    </Link>
                  </li>
                </ul>
              ...
              <li className={props.active == 'bulk' && 'active'}>
                <Link to="/bulk_sms" className="d_flex">
                  <div className="svg">
                    <svg
                      width={24}
                      height={24}
              ...
              <li className={props.active == 'customer' && 'active'}>
                <Link to="/customer" className="d_flex">
                  <div className="svg">
                    <svg
                      width={24}
                      height={22}
              ...
              <li className={props.active == 'website_setting' && 'active'}>
              ...
              <li className={props.active == 'plugin' && 'active'}>
                <Link to="/plugins" className="d_flex">
                  <div className="svg">
                    <svg
                      width={18}
                      height={29}
              ...
              <li className={props.active == 'offer' && 'active'}>
                <Link to="/offer" className="d_flex">
                  <div className="svg">
                    <svg
                      width={20}
                      height={20}
