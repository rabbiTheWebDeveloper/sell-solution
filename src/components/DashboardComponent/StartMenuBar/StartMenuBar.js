...
const StartMenuBar = (props) => {
  ...
  const logoutSubmit = () => {
    ...
    axios.post("http://10.10.10.252/api/logout").then((res) => {
        ...
        <div className="row d_flex">
          ...
          <div className="col-lg-2">
            <div className="menu_settings d_flex d_justify">
              ...
              {/* profile */}
              <div className="profile_part profile-box ml-15">
                <button
                  ...
                  <div className="profile-info">
                    <div className="info">
                      ...
                      <div className="image">
                        ...
                        {/* <h5>{localStorage.getItem('token_name')}</h5> */}
